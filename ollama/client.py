...
import json
import requests
# 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
# llama-3.3-70b-versatile

BASE_URL = os.environ.get('OLLAMA_HOST', 'https://88f9-54-158-13-109.ngrok-free.app/')
...
# # Headers for authentication and optional app info
# headers = {
#     "Authorization": f"Bearer {API_KEY}",
# }

# # Generate a response for a given prompt with a provided model. This is a streaming endpoint, so it will be a series of responses.
# def generate(model_name, prompt, system=None, template=None, context=None, options=None, callback=None):
#     try:
#         url = f"{BASE_URL}/chat/completions"  # OpenRouter chat completions endpoint
#         payload = {
#             "model": model_name,
...
#         # Making a POST request with stream=True to handle streaming responses
...
#                         # If this is not the last chunk, add the "response" field value to full_response and print it
#                         if not chunk.get("done"):
#                             response_piece = chunk.get("message", "")
#                             full_response += response_piece
#                             print(response_piece, end="", flush=True)
...
# # Example usage
# def main():
#     model_name = "mistralai/mistral-7b-instruct:free"  # The model to use
#     prompt = "What is the meaning of life?"
    
#     # Call the generate function with a prompt
